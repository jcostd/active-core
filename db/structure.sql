...
CREATE INDEX "index_sales_on_discarded_at" ON "sales" ("discarded_at");
CREATE INDEX "index_sales_on_member_id" ON "sales" ("member_id");
CREATE INDEX "index_sales_on_product_id" ON "sales" ("product_id");
CREATE INDEX "index_sales_on_receipt_code" ON "sales" ("receipt_code");
CREATE UNIQUE INDEX "idx_on_receipt_year_receipt_sequence_receipt_number_3689acdaf9" ON "sales" ("receipt_year", "receipt_sequence", "receipt_number") WHERE receipt_number IS NOT NULL;
CREATE INDEX "index_sales_on_sold_on" ON "sales" ("sold_on");
CREATE INDEX "index_sales_on_user_id" ON "sales" ("user_id");
...
CREATE INDEX "index_subscriptions_on_discarded_at" ON "subscriptions" ("discarded_at");
CREATE INDEX "index_subscriptions_on_member_id_and_end_date" ON "subscriptions" ("member_id", "end_date");
CREATE INDEX "index_subscriptions_on_member_id" ON "subscriptions" ("member_id");
CREATE INDEX "index_subscriptions_on_product_id" ON "subscriptions" ("product_id");
CREATE INDEX "index_subscriptions_on_sale_id" ON "subscriptions" ("sale_id");
...
CREATE TABLE IF NOT EXISTS 'members_fts_data'(id INTEGER PRIMARY KEY, block BLOB);
CREATE TABLE IF NOT EXISTS 'members_fts_idx'(segid, term, pgno, PRIMARY KEY(segid, term)) WITHOUT ROWID;
CREATE TABLE IF NOT EXISTS 'members_fts_docsize'(id INTEGER PRIMARY KEY, sz BLOB);
CREATE TABLE IF NOT EXISTS 'members_fts_config'(k PRIMARY KEY, v) WITHOUT ROWID;
