...
CREATE INDEX "index_disciplines_on_discarded_at" ON "disciplines" ("discarded_at") /*application='ActiveCoreMinimal'*/;
CREATE UNIQUE INDEX "index_disciplines_on_name" ON "disciplines" ("name") WHERE discarded_at IS NULL /*application='ActiveCoreMinimal'*/;
...
CREATE INDEX "index_products_on_discarded_at" ON "products" ("discarded_at") /*application='ActiveCoreMinimal'*/;
CREATE UNIQUE INDEX "index_products_on_name" ON "products" ("name") WHERE discarded_at IS NULL /*application='ActiveCoreMinimal'*/;
...
CREATE UNIQUE INDEX "index_receipt_counters_on_year_and_sequence_category" ON "receipt_counters" ("year", "sequence_category") /*application='ActiveCoreMinimal'*/;
...
CREATE INDEX "index_activity_logs_on_subject" ON "activity_logs" ("subject_type", "subject_id") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_activity_logs_on_user_id_and_created_at" ON "activity_logs" ("user_id", "created_at") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_activity_logs_on_user_id" ON "activity_logs" ("user_id") /*application='ActiveCoreMinimal'*/;
...
CREATE INDEX "index_feedbacks_on_status" ON "feedbacks" ("status") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_feedbacks_on_user_id" ON "feedbacks" ("user_id") /*application='ActiveCoreMinimal'*/;
...
CREATE INDEX "index_product_disciplines_on_discipline_id" ON "product_disciplines" ("discipline_id") /*application='ActiveCoreMinimal'*/;
CREATE UNIQUE INDEX "index_product_disciplines_on_product_id_and_discipline_id" ON "product_disciplines" ("product_id", "discipline_id") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_product_disciplines_on_product_id" ON "product_disciplines" ("product_id") /*application='ActiveCoreMinimal'*/;
...
CREATE INDEX "index_sales_on_discarded_at" ON "sales" ("discarded_at") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_sales_on_member_id" ON "sales" ("member_id") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_sales_on_product_id" ON "sales" ("product_id") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_sales_on_receipt_code" ON "sales" ("receipt_code") /*application='ActiveCoreMinimal'*/;
CREATE UNIQUE INDEX "idx_on_receipt_year_receipt_sequence_receipt_number_3689acdaf9" ON "sales" ("receipt_year", "receipt_sequence", "receipt_number") WHERE receipt_number IS NOT NULL /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_sales_on_sold_on" ON "sales" ("sold_on") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_sales_on_user_id" ON "sales" ("user_id") /*application='ActiveCoreMinimal'*/;
...
CREATE INDEX "index_subscriptions_on_discarded_at" ON "subscriptions" ("discarded_at") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_subscriptions_on_member_id_and_end_date" ON "subscriptions" ("member_id", "end_date") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_subscriptions_on_member_id" ON "subscriptions" ("member_id") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_subscriptions_on_product_id" ON "subscriptions" ("product_id") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_subscriptions_on_sale_id" ON "subscriptions" ("sale_id") /*application='ActiveCoreMinimal'*/;
CREATE TABLE IF NOT EXISTS "schema_migrations" ("version" varchar NOT NULL PRIMARY KEY);
CREATE TABLE IF NOT EXISTS "ar_internal_metadata" ("key" varchar NOT NULL PRIMARY KEY, "value" varchar, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
CREATE TABLE IF NOT EXISTS "access_logs" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "checkin_by_user_id" integer NOT NULL, "created_at" datetime(6) NOT NULL, "entered_at" datetime(6) NOT NULL, "medical_certificate_valid" boolean DEFAULT FALSE NOT NULL, "member_id" integer NOT NULL, "subscription_id" integer, "updated_at" datetime(6) NOT NULL, "discipline_id" integer, "status" integer DEFAULT 0 NOT NULL /*application='ActiveCoreMinimal'*/, CONSTRAINT "fk_rails_df50081f1b"
...
CREATE INDEX "index_access_logs_on_checkin_by_user_id" ON "access_logs" ("checkin_by_user_id") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_access_logs_on_entered_at" ON "access_logs" ("entered_at") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_access_logs_on_member_id_and_entered_at" ON "access_logs" ("member_id", "entered_at") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_access_logs_on_member_id" ON "access_logs" ("member_id") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_access_logs_on_subscription_id" ON "access_logs" ("subscription_id") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_access_logs_on_discipline_id" ON "access_logs" ("discipline_id") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_access_logs_on_status" ON "access_logs" ("status") /*application='ActiveCoreMinimal'*/;
...
CREATE INDEX "index_users_on_discarded_at" ON "users" ("discarded_at") /*application='ActiveCoreMinimal'*/;
CREATE UNIQUE INDEX "index_users_on_email_address" ON "users" ("email_address") WHERE discarded_at IS NULL /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_users_on_preferences" ON "users" ("preferences") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_users_on_role" ON "users" ("role") /*application='ActiveCoreMinimal'*/;
CREATE UNIQUE INDEX "index_users_on_username" ON "users" ("username") WHERE discarded_at IS NULL /*application='ActiveCoreMinimal'*/;
...
CREATE INDEX "index_members_on_discarded_at" ON "members" ("discarded_at") /*application='ActiveCoreMinimal'*/;
CREATE UNIQUE INDEX "index_members_on_fiscal_code" ON "members" ("fiscal_code") WHERE discarded_at IS NULL /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_members_on_full_address" ON "members" ("full_address") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_members_on_full_name" ON "members" ("full_name") /*application='ActiveCoreMinimal'*/;
CREATE INDEX "index_members_on_medical_certificate_expiry" ON "members" ("medical_certificate_expiry") /*application='ActiveCoreMinimal'*/;
